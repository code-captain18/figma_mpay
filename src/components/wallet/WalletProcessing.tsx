...
export function WalletProcessing({ referenceId, walletToWallet }: { referenceId: string; walletToWallet?: boolean }) {
  return (
    <ScrollView
    ...
    >
      ...
      <Text style={{ fontSize: 20, fontWeight: '800', color: C.navy, fontFamily: 'Urbanist_800ExtraBold', marginBottom: 10, textAlign: 'center' }}>
        {walletToWallet ? 'Confirming transfer…' : 'Processing transaction'}
      </Text>
      ...
      <Text style={{ fontSize: 12, color: C.mid, textAlign: 'center', fontFamily: 'Urbanist_400Regular', lineHeight: 18, marginBottom: 30 }}>
        {walletToWallet
          ? 'Please wait while we confirm your wallet transfer. This usually takes a few seconds.'
