...
const s = StyleSheet.create({
  ...
  sectionKey:    { fontSize: 9, fontFamily: F.extrabold, color: C.blue, letterSpacing: 1.2 },
  colLabelRow:   { flexDirection: 'row', gap: 4 },
  colLabel:      { width: CELL_W, textAlign: 'center', fontSize: 8, fontFamily: F.semibold, color: C.mid },
